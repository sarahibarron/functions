...
//eslint-disable-line     let result = a + b;     let string = "The sum of " + a + " and " + b + " is " + result + ".";     return [result, string];   }   function multiply(a, b) {     //eslint-disable-line     let result = a * b;     let string = "The product of " + a + " and " + b + " is " + result + ".";     return [result, string];   }   return [ans, ans2, string3, string4];
